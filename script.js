...
window.addEventListener("keydown", (event) => {
    ...
    /* Uzvicnik (!) automatski prebacuje statement kao da pisemo else /
    Pisemo samo ono sto bi pisali u else kod-u */
    if(!keyElement) return; // Pisemo bez {} jer je samo jedan uslov!
